...
public class DP8 {
    ...
    public static int lcs1(String str1,String str2,int n,int m,int dp[][]){
        ...
        if(str1.charAt(n-1)==str2.charAt(m-1)){//same
            dp[n][m]=lcs1(str1,str2,n-1,m-1,dp)+1;
            return dp[n][m];
        }else{//for in different cases
    ...
    //tabulation
    public static int lc3(String str1,String str2,int n,int m){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lc3(str1, str2, n, m));
